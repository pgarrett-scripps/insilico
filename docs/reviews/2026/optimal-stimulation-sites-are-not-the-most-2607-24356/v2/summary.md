...
**Average reviewer score:** 3.88/5

## Editorial Audits
- **Citation Integrity Auditor** — 0 HARD gap(s), 2 SOFT gap(s)
- **Methods Completeness & Reagent Traceability Auditor** — 1 HARD gap(s), 1 SOFT gap(s)
- **Revision Compliance** — 5 HARD gap(s), 5 SOFT gap(s)

**OpenRouter cost:** $2.3750