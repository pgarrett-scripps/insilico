# Review Summary — On the sensitivity of machine-learned probabilistic weather forecast
...
**Average reviewer score:** 4.00/5

## Editorial Audits
- **Citation Integrity Auditor** — 0 HARD gap(s), 7 SOFT gap(s)
- **Methods Completeness & Reagent Traceability Auditor** — 3 HARD gap(s), 11 SOFT gap(s)

**OpenRouter cost:** $1.1737